                ...
                <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="lg:w-2/3 space-y-8">
                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden relative group">
                            <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm z-10 flex items-center">
                                {auctionData.status === "ENDED" ? (
                                    <span className="text-gray-600 flex items-center"><span className="w-2 h-2 bg-gray-400 rounded-full mr-2"></span>Ended</span>
                                ) : (
                                    <span className="text-red-500 flex items-center"><span className="w-2 h-2 bg-red-500 rounded-full mr-2 animate-pulse"></span>Live Auction</span>
                                )}
                            </div>
                            <div className="aspect-w-16 aspect-h-9 h-96 bg-gray-100">
                                <img 
                                    src={`https://ui-avatars.com/api/?name=${encodeURIComponent(auctionData.title || 'Item')}&background=random&size=800`} 
